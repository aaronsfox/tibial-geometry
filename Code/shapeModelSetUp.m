...
optionStruct.nb_pts = 5000; %Set desired number of points
...
for ii = 1:length(caseID)
    ...
    %Load the tibia
    [tibiaSTLstruct] = import_STL([caseNo,'-tibia-cortical.stl']);
...
% % %         error('There are holes in your tibia...')
% % %     end
...
% % %         tibiaF = patchRemoveCollapsed(tibiaF);
