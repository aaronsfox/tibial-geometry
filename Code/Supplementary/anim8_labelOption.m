function hf=anim8_labelOption(varargin)
...
% ------------------------------------------------------------------------
%
% Edited by Aaron Fox to add an option to label the 'time' bar with
...
iconPath=fullfile(toolboxPath,'Supplementary\icons');
...
hTextTime = uicontrol(hf,'Style','text',...
    'String',[' ',animStruct.labelOption,': ',sprintf('%f',animTime(1))],...
...
set(hf.UserData.anim8.ButtonHandles.hTextTime,'String',[' ',animStruct.labelOption,': ',sprintf('%f',T)],'FontSize',hf.UserData.anim8.fontSize);
